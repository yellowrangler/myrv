...
var Fireworks = (function() {
  ...
  function initialize() {
    ...
    // setInterval(function(){ runFireworks(); }, 5000);
  ...
  function runFireworks ()
  {
      ...
      fireworksShot = fireworksShot + 1;

      if (fireworksShot > 4)
      {
          stopFireworks();

          $("#msg").text("Happy New Year From the Folks at Daredevil Ducks!");
  ...
  {
      interval = setInterval(function(){ runFireworks(); }, 1000);
  }

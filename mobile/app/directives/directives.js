...
myrvAppMobile.directive('myrvdatepicker', function () {
    return {
        restrict: 'A',
        require: 'ngModel',
...
myrvAppMobile.directive('stateListDisplay', function () {
    return {
        restrict: 'E',
        scope: {
            nameid: '@'
...
myrvAppMobile.directive('yesNoListDisplay', function () {
    return {
        restrict: 'E',
        scope: {
            nameid: '@',
...
myrvAppMobile.directive('statusListDisplay', function () {
    return {
        restrict: 'E',
        scope: {
            nameid: '@',
...
myrvAppMobile.directive('phoneNumberDisplay', function () {
    return {
        restrict: 'E',
        scope: {
            nameid: '@',
